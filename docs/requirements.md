...
This document defines the functional and non-functional requirements for the Network Traffic Analyzer, a student Computer Networks project built over 6 one-week Agile sprints. It is scoped to be achievable in that timeframe — see [Out of Scope](#5-out-of-scope) below.
